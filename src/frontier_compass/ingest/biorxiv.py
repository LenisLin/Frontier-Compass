"""bioRxiv ingestion via the public RSS feed."""
...
class BioRxivClient:
    feed_url_template = "https://connect.biorxiv.org/biorxiv_xml.php?subject={subject}"
    recent_listing_url = "https://www.biorxiv.org/content/early/recent"
        ...
        *,
            ...
            try:
                ...
                return (
                    fetch_text(
                        ...
                        source_label="bioRxiv recent listing",
                    ),
                    self.recent_listing_url,
                    "recent-html",
                    fallback_note,
        ...
        if contract_mode == "recent-html" and not papers:
            raise FeedRequestError(
                f"bioRxiv recent listing at {endpoint} returned no parseable papers after RSS fallback."
            )
    ...
    def fetch_today_details(
        ...
        *,
        ...
        if details.contract_mode == "recent-html" and target_date not in details.available_dates:
            ...
            raise FeedRequestError(
                "bioRxiv live fallback cannot satisfy historical day "
